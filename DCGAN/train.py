...
if __name__ == '__main__':
	gan = DCGAN("../dataset/cats/normalized", training_progress_save_path="training_data", progress_image_dim=(16, 9),
	            ...
	            generator_weights="training_data/weights/400000", discriminator_weights="training_data/weights/400000",
	            start_episode=400_000)
	...
	try:
		gan.train(20_000, 32, progress_images_save_interval=200, save_training_stats=True,
		          ...
		          feed_prev_gen_batch=True, feed_amount=0.15, half_batch_discriminator=False, auto_training_balancing=True)
		gan.save_weights()
	...
	if input("Make progress gif?\n") == "y": gan.make_progress_gif(save_path="training_data", framerate=10)
