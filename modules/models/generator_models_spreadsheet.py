...
def mod_base_3upscl(inp:Layer, image_shape:tuple, image_channels:int, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  ...
  m = deconv_layer(m, 512, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (2*st_s, 2*st_s, 512) -> (4*st_s, 4*st_s, 256)
  m = deconv_layer(m, 256, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (4*st_s, 4*st_s, 256) -> (8*st_s, 8*st_s, 128)
  m = deconv_layer(m, 128, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (8*st_s, 8*st_s, 128) -> (8*st_s, 8*st_s, 64)
  m = deconv_layer(m, 64, kernel_size=3, strides=1, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (8*st_s, 8*st_s, 64) -> (8*st_s, 8*st_s, 32)
  m = deconv_layer(m, 32, kernel_size=3, strides=1, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)
...
def mod_ext_3upscl(inp:Layer, image_shape:tuple, image_channels:int, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  ...
  m = deconv_layer(m, 1024, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (2*st_s, 2*st_s, 1024) -> (4*st_s, 4*st_s, 512)
  m = deconv_layer(m, 512, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (4*st_s, 4*st_s, 512) -> (4*st_s, 4*st_s, 512)
  m = deconv_layer(m, 512, kernel_size=3, strides=1, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (4*st_s, 4*st_s, 512) -> (8*st_s, 8*st_s, 256)
  m = deconv_layer(m, 256, kernel_size=3, strides=2, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (8*st_s, 8*st_s, 256) -> (8*st_s, 8*st_s, 256)
  m = deconv_layer(m, 256, kernel_size=3, strides=1, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)

  # (8*st_s, 8*st_s, 256) -> (8*st_s, 8*st_s, 128)
  m = deconv_layer(m, 128, kernel_size=3, strides=1, use_subpixel_conv2d=False, act="relu", batch_norm=0.8, kernel_initializer=kernel_initializer)
