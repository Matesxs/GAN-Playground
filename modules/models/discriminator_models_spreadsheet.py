...
def mod_testing(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
...
def mod_testing2(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
  m = conv_layer(m, 64, kernel_size=3, strides=2, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
...
def mod_testing3(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
  m = conv_layer(m, 64, kernel_size=3, strides=2, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
...
def mod_testing4(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
  m = conv_layer(m, 64, kernel_size=3, strides=2, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
...
def mod_testing5(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, act="leaky", use_bias=True, kernel_initializer=kernel_initializer)
...
def mod_testing6(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
...
def mod_testing7(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
...
def mod_testing8(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = GaussianNoise(0.2)(inp)
