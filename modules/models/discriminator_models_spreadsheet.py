...
def mod_base_9layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, leaky=True, kernel_initializer=kernel_initializer)
...
def mod_base_10layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
  m = conv_layer(inp, 64, kernel_size=3, strides=1, dropout=None, batch_norm=None, leaky=True, kernel_initializer=kernel_initializer)
  ...
  m = conv_layer(m, 1024, kernel_size=3, strides=1, dropout=None, batch_norm=0.5, leaky=True, kernel_initializer=kernel_initializer)
  m = conv_layer(m, 1024, kernel_size=3, strides=2, dropout=None, batch_norm=0.5, leaky=True, kernel_initializer=kernel_initializer)
