...
def mod_base_6layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
	...
	m = Conv2D(128, (3, 3), padding='same', strides=(1, 1), kernel_initializer=kernel_initializer)(m)
	m = LeakyReLU(0.2)(m)
	m = Dropout(0.25)(m)
	m = BatchNormalization(momentum=0.8)(m)
	...
	m = Conv2D(1024, (3, 3), padding='same', strides=(2, 2), kernel_initializer=kernel_initializer)(m)
	m = LeakyReLU(0.2)(m)
	m = Dropout(0.25)(m)
