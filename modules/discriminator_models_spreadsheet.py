...
def mod_extD_4layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
	m = Conv2D(32, (4, 4), strides=(2, 2), padding="same", kernel_initializer=kernel_initializer)(inp)
	m = LeakyReLU(0.2)(m)
	m = Dropout(0.5)(m)

	m = Conv2D(64, (4, 4), padding="same", kernel_initializer=kernel_initializer)(m)
	m = BatchNormalization()(m)
	m = LeakyReLU(0.2)(m)
	m = Dropout(0.5)(m)
	...
	m = Conv2D(256, (4, 4), padding="same", kernel_initializer=kernel_initializer)(m)
	m = BatchNormalization()(m)
	m = LeakyReLU(0.2)(m)
	m = Dropout(0.5)(m)
...
def mod_ext_5layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
	m = Conv2D(64, (4, 4), padding='same', strides=(2, 2), kernel_initializer=kernel_initializer)(inp)
	m = LeakyReLU(0.2)(m)
	...
	m = Conv2D(1024, (4, 4), padding='same', strides=(2, 2), kernel_initializer=kernel_initializer)(m)
	m = BatchNormalization()(m)
	m = LeakyReLU(0.2)(m)
...
def mod_ext2_5layers(inp:Layer, kernel_initializer:Initializer=RandomNormal(stddev=0.02)):
	m = Conv2D(64, (4, 4), padding='same', strides=(2, 2), kernel_initializer=kernel_initializer)(inp)
	m = LeakyReLU(0.2)(m)

	m = Conv2D(128, (4, 4), padding='same', kernel_initializer=kernel_initializer)(m)
	m = BatchNormalization()(m)
	m = LeakyReLU(0.2)(m)
	...
	m = Conv2D(512, (4, 4), padding='same', kernel_initializer=kernel_initializer)(m)
	m = BatchNormalization()(m)
	m = LeakyReLU(0.2)(m)
