...
if __name__ == '__main__':
	gan = DCGAN("dataset/cats/normalized", training_progress_save_path="training_data", progress_image_dim=(10, 10),
	            ...
	            generator_weights="training_data/weights/335000", discriminator_weights="training_data/weights/335000",
	            start_episode=335_000)
	...
	while True:
		try:
			gan.train(15_000, 32, progress_images_save_interval=200, agregate_stats_interval=100,
